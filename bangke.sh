...
clear
echo -e "\033[0m"
echo -e "${RED}APPOLO${RESET}${BLUE}MAKLU${RESET}"
...
REPO_URL="https://github.com/Botzzvinz/ellysial"
TEMP_DIR="ellysial"
...
echo -e "${GREEN}Installing ${YELLOW}sudo${GREEN} if not installed${RESET}"
    ...
    1)
        ...
        GITHUB_TOKEN="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"
